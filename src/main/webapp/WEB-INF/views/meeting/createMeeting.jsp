	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav m-auto">
				<li class="nav-item active"><a href="<c:url value='/town/AllOfMeeting.do'/>" class="nav-link">동네 둘러보기</a></li>
	...
	<div class="row">
		<div class="offset-6 col-6" >				
			...
			<span style="float: right;"> 
				...
				<a href="<c:url value='#'/>">
                    <button class="btn btn-primary" style="width: 100px; height: 50;">생성하기</button>
				</a>
			</span>
		</div>
	</div>
...
<form id="frm" method="post" enctype="multipart/form-data" action="<c:url value='/CreateNewMeeting.do'/>">
    <div class="filebox">
    	<div id="image"
    ...
    <p style="text-align: center;">※ 가로로 긴 이미지를 선택하시면 좋습니다.</p>
...
console.log(document.getElementById('field').childElementCount);
  if(document.getElementById('field').childElementCount==19){
     ...
     div.innerHTML = "<input type='text' id='memberRole' name='memberRole' class='form-control'></input><input type='button' style='background-color:#f19c05; color:white; border:none; border-radius:5px; height:52px;' value='-' onclick='remove_div(this)'>";
...
$('#submitBtn').click(function() {
	if($('#gdsImg').val()==""|| $('#addr').val()=="" ||$('#mainCategory').val()=="" ||$('#subCategory').val()==""||$('#title').val()==""||$('#operatorRole').val()==""||$('#subCategory').val()==""||$('#summernote').val()==""||$('#memberRole').val()==""){

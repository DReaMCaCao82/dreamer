...
<div class="container">
	<div class="row">
		<div class="offset-6 col-6">
			...
			<span style="float: right; width: 45%;">
				<a href="<c:url value='/performance/PerformanceList.do'/>">
	...
	<!-- 배너 -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('resources/images/banner9.jpg');" data-stellar-background-ratio="0.5">
		          ...
		          <div class="col-md-12">
		          	<div class="row mb-4">
						<div class="col-md-12 d-flex justify-content-between align-items-center">
							<h4 class="product-select">진행 중인 공연이 더 많이 궁금하신가요?</h4>	
							<a href="<c:url value='/PerformanceList.do'/>">
		                        <button class="btn btn-primary" style="width: 150px; height: 30;">전제 공연 보기</button>
							</a>
						</div>
					</div>
		          </div>

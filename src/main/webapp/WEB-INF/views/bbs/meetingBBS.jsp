	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate mb-0 text-center" style="background-color: rgba(239,239,239,0.9); border-radius: 12px 12px 12px 12px;">
				...
				<h1 class="mb-0 bread">모임 소식들을 살펴볼까요?</h1>
			</div>
		</div>
	</div>
</section>
               ...
               <div class="top-section">
                    ...
                    <div class="section-title">
                        ...
                        <div class="profile-pic" style="height: 75px;">
                            ...
                            <a href="<c:url value="/MeetingViewMain.do?meetingNo=${items['MEETINGNO']}"/>">
                            ...
                            <div style="display: inline; vertical-align: bottom;">
		                    	...
		                    	<c:forEach items="${items.member }" var="member">
	...
	<div class="col-md-3 col-md-offset-8"
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>모임 TOP.5</h3>
                <ul>
	                <!-- <li style="display: flex;"><a href="<c:url value="'/MeetingViewMain.do?meetingNo=${item.meetingNo}'"/>">내이야기들어줄래<span class="fa fa-chevron-right"></span></a></li> -->
	                <li style="display: flex;"><a href="#">프로아니지만겜덕굳<span class="fa fa-chevron-right"></span></a></li>
	                <li style="display: flex;"><a href="#">링딩밴드<span class="fa fa-chevron-right"></span></a></li>
	                <li style="display: flex;"><a href="#">코리아예고 무브무비<span class="fa fa-chevron-right"></span></a></li>
	                <li style="display: flex;"><a href="#">커버하고 리메이크<span class="fa fa-chevron-right"></span></a></li>
	                <li style="display: flex;"><a href="#">개발자 컴히얼<span class="fa fa-chevron-right"></span></a></li>
	            </ul>
              </div>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              <h3>다가오는 이벤트</h3>
              <ul class="top">
              	<li>◈ <a href="#">운동초교 어린이 축구팀 경기 라이브</a></li>
              	<li>◈ <a href="#">아이유 커버 옥상버스킹</a></li>
              	<li>◈ <a href="#">링딩밴드 너튜브 라이브 공연</a></li>
              	<li>◈ <a href="#">코리아예고 단편영화 개봉</a></li>
              	<li>◈ <a href="#">개발 앱 "쉴그늘" 최초 공개</a></li>
              </ul>
            </div>
...
$(document).ready(function(){
    ...
    $('.box').each(function(){
        ...
        //var content = $(this).find('#contents${items["BBSNO"]}');

        ...
        <div class="container">
               ...
               <div class="row">
				<div class="col-md-9" style="margin: auto;">
					<form id="frm" class="form-horizontal"  enctype="multipart/form-data" method="post" action="<c:url value='/bbs/WriteNewMeetingBBS.do'/>">
						
						<input type="hidden" id="meetingNo" name="meetingNo" value="${meetingNo }">
						...
						<div class="form-inline">
				        	<div id="field" class="row" style="margin-left: 1%; margin-bottom: 2%;">
				        		...
				        		<div>
					        		<div id="image1" name="image1" style="margin:0 auto; margin-top: 5%; height: 162px; width: 162px; border: 1px solid gray; background-repeat: no-repeat; background-size: cover;">
		     				 			<div>
			     				 			<label for="cma_file1" disabled="disabled">사진 선택</label>
								 			<input type="file" name="cma_file" id="cma_file1" onchange="getThumbnailPrivew(this,$('#image1'))"/>
							 			</div>
						 			</div>
						 			<input type="hidden" style="background-color:#FFB8A8; color:white; border:none; border-radius:5px; height:30px; margin-left:50px;" value="삭제" onclick="remove_div(this)">
						 		</div>	
						...
						<div class="form-group">
							...
							<div>
								<div class="row">
									<textarea id="summernote" name="content" style="width: 100%; height: 400px;" placeholder="내용을 입력하세요"></textarea>
								</div>
							</div>
						</div>

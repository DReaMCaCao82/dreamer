	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate mb-0 text-center" style="background-color: rgba(239,239,239,0.9); border-radius: 12px 12px 12px 12px;">
				...
				<h1 class="mb-0 bread">일상과 꿈에 대해 다른 드리머들과 나눠보세요!</h1>
			</div>
		</div>
	</div>
</section>
        ...
        <div class="container">
               ...
               <div class="row">
				<div class="col-md-9" style="margin: auto;">
					<form id="frm" class="form-horizontal"  enctype="multipart/form-data" method="post" action="<c:url value='/bbs/WriteNewFreeBBS.do'/>">
						
						<div class="form-group">
							<input type="button" value="사진 추가" id="makeRole" class="btn btn-primary" onclick="add_div()"/>
							<p style="display: inline;">※ 자유 게시판은 최대 5장의 사진 첨부를 할 수 있습니다.</p>
						</div>
						
						<div class="form-inline">
				        	<div id="field" class="row" style="margin-left: 1%; margin-bottom: 2%;">
						 		<!-- 사진 추가 버튼 누를 시 선택창 들어갈 부분 -->
				        	</div>
						</div>
...
console.log("추가 전 : "+i);
  if(document.getElementById('field').childElementCount==5){
     ...
     div.innerHTML = "<div id=\"image"+i+"\" name=\"image"+i+"\" style='margin:0 auto; margin-top: 5%; height: 162px; width: 162px; border: 1px solid gray; background-repeat: no-repeat; background-size: cover;'>"+
					 ...
					 "</div></div><input type='button' style='background-color:#f19c05; color:white; border:none; border-radius:5px; height:30px; margin-left:50px;' value='삭제' onclick='remove_div(this)'>";
